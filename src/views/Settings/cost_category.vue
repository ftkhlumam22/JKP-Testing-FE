    ...
    <template #content>
      <div class="bg-gray-200 h-auto">
          ...
          >
            ...
            <template slot="action" slot-scope="props">
              <div class="flex items-center">
                <button
                  @click="editCostCategory(props.item.id)"
          ...
          <notification
            ...
            :message="
              dataSelected.length === 0
                ...
                : 'Berhasil! Kategori Biaya sudah diubah!'
            "
        ...
        >
          <modal
            v-show="deleteConfirmModal"
            title="Hapus Data Kategori Biaya"
            message="Anda yakin ingin menghapus data cost_category ini?<br/> Data akan dihapus secara permanen. Tindakan ini tidak bisa dibatalkan."
            @close="
              deleteConfirmModal = false;
              dataSelected = [];
            "
            @confirm="deleteCostCategory()"
          ></modal>
        </transition>
