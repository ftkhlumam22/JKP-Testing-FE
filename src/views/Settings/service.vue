      ...
      <div class="bg-gray-200 h-auto">
            ...
            <template slot="service_type" slot-scope="props">
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                  <button
                    @click="editService(props.item.id)"
        ...
        >
          <addForm
            ...
            :title="
              dataSelected.length === 0 ? 'Tambah Layanan' : 'Ubah Layanan'
            "
            @submit="handleSubmit"
          >
            <div class="space-y-4">
...
export default {
  ...
  methods: {
    ...
    async createService() {
      ...
      try {
        const response = await axios.post(
          `${api_url}/api/v1/shipping-rates/service/create`,
          data,
    ...
    async editService(id) {
      try {
        const response = await axios.get(
          `${api_url}/api/v1/shipping-rates/service/get/${id}`,
          { headers: this.headers }
        );
        console.log(response);
        ...
        /* Set Data Form */
        this.service_name = this.dataSelected.service_name;
    ...
    async updateService() {
      ...
      try {
        const response = await axios.put(
          `${api_url}/api/v1/shipping-rates/service/update/${this.dataSelected.id}`,
          data,
          { headers: this.headers }
        );
        console.log(response.data);
    ...
    async deleteService() {
      try {
        const response = await axios.delete(
          `${api_url}/api/v1/shipping-rates/service/delete/${this.dataSelected.id}`,
          { headers: this.headers }
        );
        console.log(response.data);
    ...
    async resetDataService() {
      try {
        const response = await axios.delete(
          `${api_url}/api/v1/shipping-rates/service/delete-all`,
          { headers: this.headers }
        );
        console.log(response.data);
    ...
    async uploadFileCSV(event) {
      ...
      try {
        const response = await axios.post(
          `${api_url}/api/v1/shipping-rates/service/import`,
          data,
          { headers: this.headers }
        );
        console.log(response.data);
