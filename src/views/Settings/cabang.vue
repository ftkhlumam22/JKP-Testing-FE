      ...
      <div class="bg-gray-200 h-auto">
          ...
          >
            ...
            <template slot="action" slot-scope="props">
              <div class="flex items-center">
                <button
                  @click="editBranch(props.item.id)"
        ...
        >
          <addForm
            ...
            :title="dataSelected.length === 0 ? 'Tambah Cabang' : 'Ubah Cabang'"
            @submit="handleSubmit"
          >
            <div class="space-y-4">
              <div>
        ...
        >
          <modal
            ...
            message="Anda yakin ingin menghapus data cabang ini?<br/> Data akan dihapus secara permanen. Tindakan ini tidak bisa dibatalkan."
            @close="
...
export default {
  ...
  methods: {
    ...
    async createBranch() {
      ...
      try {
        const response = await axios.post(
          `${api_url}/api/v1/master/branch/create`,
          data,
    ...
    async editBranch(id) {
      try {
        const response = await axios.get(
          `${api_url}/api/v1/master/branch/get/${id}`,
          { headers: this.headers }
        );
        console.log(response);
        ...
        /* Set Data Form */
        this.city_name = this.dataSelected.city_name;
    ...
    async updateBranch() {
      ...
      try {
        const response = await axios.put(
          `${api_url}/api/v1/master/branch/update/${this.dataSelected.id}`,
          data,
          { headers: this.headers }
        );
        console.log(response.data);
    ...
    async deleteBranch() {
      try {
        const response = await axios.delete(
          `${api_url}/api/v1/master/branch/delete/${this.dataSelected.id}`,
          { headers: this.headers }
        );
        console.log(response.data);
