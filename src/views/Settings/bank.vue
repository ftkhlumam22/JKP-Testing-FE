...
export default {
  ...
  methods: {
    ...
    async createBank() {
      ...
      try {
        const response = await axios.post(
          `${api_url}/api/v1/master/bank/create`,
          data,
    ...
    async editBank(id) {
      try {
        const response = await axios.get(
          `${api_url}/api/v1/master/bank/get/${id}`,
          { headers: this.headers }
        );
        console.log(response);
    ...
    async updateBank() {
      ...
      try {
        const response = await axios.put(
          `${api_url}/api/v1/master/bank/update/${this.dataSelected.id}`,
          data,
          { headers: this.headers }
        );
        console.log(response.data);
    ...
    async deleteBank() {
      try {
        const response = await axios.delete(
          `${api_url}/api/v1/master/bank/delete/${this.dataSelected.id}`,
          { headers: this.headers }
        );
        console.log(response.data);
