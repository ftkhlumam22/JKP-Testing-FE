      ...
      <div class="bg-gray-200 h-auto">
        <div class="container px-4 py-10 mx-auto max-w-7xl">
          ...
          >
            ...
            <template slot="is_status" slot-scope="props">
              <div v-if="props.item.is_status" class="text-green-400">
                Aktif
              </div>
            ...
            <template slot="action" slot-scope="props">
              <div class="flex items-center">
                ...
                <button
                  ...
                  "
                  class="bg-red-400 hover:bg-red-500 border border-red-500 hover:border-red-600 focus:border-red-600 rounded-md px-3 py-1 text-white focus:outline-none flex items-center"
                  style="font-size: 11px"
                >
                  <svg
                    class="w-4 h-4 mr-2 fill-current"
        ...
        >
          <addForm
            ...
            :title="
              dataSelected.length === 0 ? 'Tambah Agen' : 'Ubah Data Agen'
            "
            @submit="handleSubmit"
          >
            <div class="space-y-4">
              ...
              <div>
                ...
                <input
                  v-model="subdistrict"
                  class="w-full rounded-md border-2 border-gray-300 focus:outline-none focus:border-blue-800 text-sm px-3 py-2"
                  placeholder="contoh: Gunung Jati"
                  type="text"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full rounded-md border-2 border-gray-300 focus:outline-none focus:border-blue-800 text-sm px-3 py-2"
                  placeholder="contoh: Isi dengan Koordinat/Longlat"
                  type="text"
                />
              </div>
              <div>
                ...
                <img
                  v-if="
                    photo_location.imageName && photo_location.imageName !== ''
                  "
                  :src="photo_location.imageURL"
                  width="250"
                  class="mb-2"
                />
                <img v-else :src="photo_location" width="250" class="mb-2" />
                <input
                  id="upload-photo-location"
                  accept="image/*"
                  class="hidden"
                  type="file"
                  @change="uploadFileImageLocation($event)"
                />
                <label
              ...
              <div>
                ...
                <img
                  v-if="photo_ktp.imageName && photo_ktp.imageName !== ''"
                  :src="photo_ktp.imageURL"
                  width="250"
                  class="mb-2"
                />
                ...
                <input
                  ...
                  class="hidden"
                  type="file"
                  @change="uploadFileImageKTP($event)"
                />
                <label
          ...
          <notification
            ...
            :message="
              dataSelected.length === 0
                ? 'Berhasil! Agen baru sudah ditambahkan!'
                : 'Berhasil! Agen sudah diubah!'
            "
        ...
        >
          ...
          >
            <dl>
              ...
              <div
                v-for="(item, index) in dataSelected.questions"
                :key="index"
                class="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
              >
                <dt class="text-xs font-medium text-gray-500">
              ...
              >
                ...
                >
                  <img
                    :src="dataSelected.photo_location"
                    width="150"
                    class="mb-2"
                  />
                </dd>
    ...
    async createAgen() {
      ...
      try {
        const response = await axios.post(
          `${api_url}/api/v1/users/agen/create/admin`,
          data,
          { headers: this.headers }
        );
    ...
    async editAgen(id) {
      try {
        const response = await axios.get(
          `${api_url}/api/v1/users/agen/get/${id}`,
          { headers: this.headers }
        );
        console.log(response);
    ...
    async updateAgen() {
      ...
      try {
        const response = await axios.put(
          `${api_url}/api/v1/users/agen/update/${this.dataSelected.id}`,
          data,
          { headers: this.headers }
        );
        console.log(response.data);
    ...
    async deleteAgen() {
      try {
        const response = await axios.delete(
          `${api_url}/api/v1/users/agen/delete/${this.dataSelected.id}`,
          { headers: this.headers }
        );
        console.log(response.data);
