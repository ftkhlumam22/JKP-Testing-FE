<template>
  <layouts>
    <template #content>
      <div class="bg-gray-100 h-auto overflow-x-scroll">
        ...
        >
          ...
          >
            <dl>
              ...
              <template v-if="profileData.role.role_name !== 'CS Pusat'">
                <div
                  class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
                >
                  <dt class="text-xs font-medium text-gray-500">
              ...
              >
                ...
                <dd class="mt-1 text-xs text-gray-900 sm:mt-0 sm:col-span-2">
                  {{
                    dataSelected.scanned_by
                      ? dataSelected.scanned_by.fullname
                      : "-"
                  }}
                </dd>
              </div>
              ...
              >
                ...
                <dd class="mt-1 text-xs text-gray-900 sm:mt-0 sm:col-span-2">
                  {{
                    dataSelected.input_by ? dataSelected.input_by.fullname : "-"
                  }}
                </dd>
              </div>
            </dl>
...
export default {
  ...
  computed: {
    ...
    totalBerat() {
      const sum = this.dataSelected.detail_volume?.reduce((a, { berat }) => {
        return a + berat;
      }, 0);
      return sum;
    },
    ...
    totalKoli() {
      return this.dataSelected.detail_volume?.reduce((a, { koli }) => {
        return a + koli;
      }, 0);
    },
  },
