      ...
      <div class="bg-gray-200 h-auto">
          ...
          >
            ...
            <template slot="action" slot-scope="props">
              <div class="flex items-center">
                <button
                  @click="detailBookingDomestic(props.item)"
        ...
        >
          <detailDataModal
            ...
            desc="Informasi booking pengiriman domestik"
            @close="
              detailModal = false;
              dataSelected = [];
            "
          >
            <dl>
              ...
              >
                ...
                <dd class="mt-1 text-xs text-gray-900 sm:mt-0 sm:col-span-2">
                  {{ dataSelected.origin ? dataSelected.origin : "-" }}
                </dd>
              </div>
              <div
                class="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
...
export default {
  ...
  methods: {
    ...
    async getListData(page, limit) {
      ...
      try {
        const response = await axios.get(
          `${api_url}/api/v1/booking/domestic/get`,
    ...
    //     try {
    //         const response = await axios.post(`${api_url}/api/v1/booking/domestic/create`, data, { headers: this.headers });
     ...
     */
    async detailBookingDomestic(item) {
      this.dataSelected = item;
      this.detailModal = true;
      // try {
      //     const response = await axios.get(`${api_url}/api/v1/booking/domestic/get/${id}`, { headers: this.headers });
      //     console.log(response);
    ...
    //     try {
    //         const response = await axios.put(`${api_url}/api/v1/booking/domestic/update/${this.dataSelected.id}`, data, { headers: this.headers });
    //         console.log(response.data);
     ...
     * Delete Method
     */
    // async deleteBookingDomestic() {
    //     try {
    //         const response = await axios.delete(`${api_url}/api/v1/booking/domestic/delete/${this.dataSelected.id}`, { headers: this.headers });
    //         console.log(response.data);
    ...
    //         this.createBookingDomestic();
    //     }else{
    //         this.updateBookingDomestic();
    //     }
    // },
    formatDate(value) {
