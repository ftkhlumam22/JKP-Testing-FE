      ...
      <span class="inline-block w-full rounded-md shadow-sm">
        ...
        >
          <div class="flex items-center space-x-3">
            ...
            <span
              class="font-medium block truncate text-gray-600"
              v-else-if="value === ''"
            >
              {{ placeholder }}
            </span>
      ...
      >
        ...
        >
          <input
            ...
            class="border border-gray-300 rounded-md py-1 px-2 focus:outline-none w-full"
            type="text"
            placeholder="Cari.."
          />
        </div>
        ...
        >
          ...
          <li
            ...
            :key="index"
            class="text-gray-900 select-none relative py-2 pl-3 pr-9  cursor-pointer hover:text-white hover:bg-blue-700 focus:outline-none focus:text-white focus:bg-blue-800"
          >
            <div class="flex items-center space-x-3">
